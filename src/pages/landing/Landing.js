...
const Intro = () => {
  ...
  <section className="landing-intro pt-5">
    ...
    <svg className="landing-intro-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 220"><path fill="#F7F9FC" fillOpacity="1" d="M0,160L1440,32L1440,320L0,320Z"></path></svg>
  </section>
)};
